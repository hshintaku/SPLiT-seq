...
fastq_folder=/home/samba/pihome/SeqData/2020/200918_M00426_0421_000000000-JB356analysis/Data/Intensities/BaseCalls
#path to the output folder
all_output_folder=/home/samba/storage0/shintaku/20200919MiSeq012
...
python /home/samba/storage0/shintaku/SPLiT-seq/fastq_index_edit.py $fastq_folder $all_output_folder/fastq_list.txt $all_output_folder XXXXCCCCCCCCCCCCCCCCCCXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXCCCCCCCCXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXCCCCCCCC 2 r
gunzip *.fastq.gz
...
for sample in $(cat $sample_ID); do umi_tools whitelist --stdin $all_output_folder/$sample*R1*gz --bc-pattern=NNNNNNNNNNCCCCCCCCCCCCCCCCCCCCCCCC --log2stderr > $all_output_folder/$sample.whitelist.txt; done
